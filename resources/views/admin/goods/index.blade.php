...
<div class="mws-panel grid_8">
  <div class="mws-panel-header">
    <span>
      <i class="icon-table"></i>菜品列表</span>
  </div>
      ...
      <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
        <thead>
          <tr role="row">
            ...
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 208px;" aria-label="Browser: activate to sort column ascending">菜品名称</th>
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 195px;" aria-label="Platform(s): activate to sort column ascending">价格</th>
            ...
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 135px;" aria-label="Engine version: activate to sort column ascending">销量</th>
        ...
        @foreach($goods as $k=>$v)
          <tr class="@if($k % 2 == 1) odd @else even @endif">
            ...
            <td class=" ">{{$v->names}}</td> 
            <td class=" "></td>
            <td class=" "><a href="/goods/edit?id={{$v->id}}" style="color:blue">修改</a><a style="color:blue"  href="/goods/delete?id={{$v->id}}">删除</a></td></tr>
        @endforeach
        </tbody>
      </table>
